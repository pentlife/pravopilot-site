...
const features = [
  ...
  ["🤖", "Разбор ситуации", "Предварительная сводка помогает собрать материалы и подготовить вопросы специалисту."],
      ...
      <section className="hero-modern">
        <div className="hero-modern-grid">
          <div className="hero-modern-content">
            <h1>Помощник по правовой информации<br/>Шаблоны и разбор за минуты</h1>
            <p className="lead">50+ бесплатных шаблонов документов, подготовка материалов и структурированная сводка для юриста — всё в боте.</p>
...
<section id="pricing"><div className="wrap"><div className="section-title"><div><div className="kicker">Тарифы</div><h2>Бесплатный старт и подписка без автосписания</h2></div><p>Базовые шаблоны доступны бесплатно. Для регулярной подготовки материалов — подписка с ручной активацией без автосписания.</p></div><div className="pricing"><div className="price"><h3>Шаблоны</h3><div className="amount">0 ₽</div><ul><li>базовые формы документов</li><li>категории по жизненным ситуациям</li><li>стартовая основа для заполнения</li><li>доступ в боте без ограничений</li></ul><a className="btn ghost" href={site.botUrl}>Получить</a></div><div className="price"><h3>Сбор материалов</h3><div className="amount">2 анализа<br/><small style={{fontSize:'16px',color:'var(--muted)'}}>в неделю бесплатно</small></div><ul><li>структура ситуации</li><li>список документов</li><li>вопросы юристу</li><li>текстовая сводка</li></ul><a className="btn ghost" href={site.botUrl}>Начать</a></div><div className="price featured"><h3>Подписка</h3><div className="amount">3 000 ₽<span style={{fontSize:'18px',color:'var(--muted)'}}>/мес</span></div><ul><li><b>безлимитная подготовка материалов</b></li><li>ручная активация администратором</li><li>без автоматического списания</li><li>все шаблоны включены</li><li>приоритетная обработка</li></ul><a className="btn primary" href={site.botUrl}>Оформить заявку →</a><p style={{fontSize:'12px',color:'var(--muted)',marginTop:'12px',textAlign:'center'}}>Напишите в боте: «Хочу подписку»</p></div><div className="price"><h3>С проверкой юриста</h3><div className="amount">4 990–7 990 ₽</div><ul><li>подготовка ботом</li><li>проверка юристом-партнёром</li><li>комментарии по доработке</li></ul><a className="btn ghost" href={site.botUrl}>Узнать</a></div></div></div></section>
      <section id="questions"><div className="wrap"><div className="section-title"><div><div className="kicker">Вопросы</div><h2>Ответы, которые снижают риск ложных ожиданий</h2></div><p>Мы прямо разделяем бесплатные шаблоны, предварительный ориентир и профессиональную юридическую помощь.</p></div><div className="questions-grid"><div className="q"><b>Шаблоны действительно бесплатные?</b><p>Да. Базовые шаблоны правовых документов доступны в боте бесплатно. Их можно использовать как стартовую форму, но важные документы лучше проверить у специалиста.</p></div><div className="q"><b>Это заменяет обращение к специалисту?</b><p>Нет. Сервис формирует предварительную справку и материалы для подготовки. Он не заменяет адвоката или юриста и не даёт юридическое заключение.</p></div><div className="q"><b>Что даёт Подготовка разбора документа?</b><p>Он помогает выделить зоны внимания для проверки специалистом, спорные условия, важные факты и вопросы для адвоката с учётом действующего законодательства.</p></div><div className="q"><b>Зачем это адвокату?</b><p>Адвокат получает структурированную сводку: факты, документы, зоны внимания и вопросы. Это облегчает первичный разбор и помогает быстрее перейти к профессиональной стратегии.</p></div><div className="q"><b>Можно использовать результат сразу?</b><p>Для простых бытовых задач — как ориентир. Для отправки, подписания, подачи в суд или спора со значимыми последствиями результат должен проверить специалист.</p></div><div className="q"><b>Если срок истекает завтра?</b><p>Обратитесь к юристу напрямую. Сервис не гарантирует выявление и контроль процессуальных сроков.</p></div></div></div></section>
