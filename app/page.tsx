...
{/* Modern Hero Section */}
      <section className="hero-modern">
        <div className="hero-modern-grid">
          <div className="hero-modern-content">
            <h1>AI-помощник для подготовки правовых материалов<br/>Шаблоны и сводка для юриста за минуты</h1>
            <p className="lead">50+ бесплатных шаблонов документов, AI-подготовка материалов и структурированная сводка для юриста — всё в боте.</p>
            ...
            <div className="hero-modern-disclaimer">
              Сервис предоставляет предварительную правовую информацию и не заменяет помощь специалиста. Для квалифицированной оценки обратитесь к юристу или адвокату.
            </div>
          </div>
      ...
      <section><div className="wrap"><div className="section-title"><div><div className="kicker">Темы проверочного запуска</div><h2>Сначала — практичные массовые сценарии</h2></div><p>Фокус на задачах, где важны шаблоны документов, подготовка фактов и предварительный разбор: без обещаний окончательного юридического решения.</p></div><div className="topics">{topics.map(item=>{const [b,t,href]=item.split('|');return <a className="topic" href={href} key={b}><b>{b}</b>{t}</a>})}</div></div></section>
