...
const options = [
  ...
  },
  {
    ...
    points: [
      ...
      "формирует структурированное резюме и вопросы специалисту",
      "сразу напоминает: результат нужно проверить у юриста или адвоката",
    ],
  },
];

const path = ["описание", "уточнения", "резюме", "проверка специалистом"];
    ...
    <section className="comparison" id="why-not-template">
      <div className="wrap">
        <div className="section-title">
          ...
          <p>
            Шаблон полезен как форма, а AI-чат — как источник идей. Но перед консультацией важнее другое:
