export const site = {
  ...
  description:
    "бот в мессенджере с бесплатными шаблонами правовых документов, предварительной автоматизированный разбор-справкой по правовым вопросам и предварительный разбором документов для подготовки к работе с адвокатом.",
};
